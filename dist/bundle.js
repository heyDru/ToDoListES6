...
var ToDoItemManager = function () {
    ...
    _createClass(ToDoItemManager, [{
        ...
        value: function GetList() {
            ...
            _events.events.on(addBtn, 'click', self.Create);
...
var Markup = exports.Markup = function () {
    ...
    _createClass(Markup, [{
        ...
        value: function GenerateItemMarkup(toDoList) {
            ...
            _lodash2.default.each(toDoList, function (toDo) {
            ...
            var html = _lodash2.default.template(listElements);
        ...
        value: function GenerateElement(tag, attributes, innerHTML) {
            ...
            _lodash2.default.each(attributes, function (value, attribute) {
        ...
        value: function GenerateAddForm() {
            ...
            _events.events.on(formAdd, 'submit', addHandler.CreateToDoItem(inputAdd.value));

...
var Events = function () {
    ...
    _createClass(Events, [{
        ...
        key: "deleteEvent",
        value: function deleteEvent(eventName, callback) {
...
var _dataStorage = __webpack_require__(5);
...
var ToDoItemManager = function () {
    ...
    _createClass(ToDoItemManager, [{
        ...
        value: function GetList() {
            ...
            _events.events.subscribe('get-todos-list', function () {
                self.GetList();
            });
        }
    }]);
...
var _todoItemManager = __webpack_require__(1);
...
var DataStorage = exports.DataStorage = function () {
  ...
  _createClass(DataStorage, [{
    ...
    key: 'UpdateToDoItem',
    value: function UpdateToDoItem(toDo) {
      var list = localStorage.getItem(storageName);
      list = JSON.parse(list);
      var index = this.SearchById(toDo._id, list);
      list[index] = toDo;
      list = JSON.stringify(list);
      localStorage.setItem(storageName, list);
    }
...
var _addHandler = __webpack_require__(6);

var _deleteHandler = __webpack_require__(12);

var _editHandler = __webpack_require__(13);
...
var deleteHandler = new _deleteHandler.DeleteHandler();
var editHandler = new _editHandler.EditHandler();
...
var Markup = exports.Markup = function () {
    ...
    _createClass(Markup, [{
        key: 'GenerateMarkup',
        value: function GenerateMarkup(toDoList) {
        ...
        value: function GenerateBaseMarkup(base) {
            var baseTemplate = document.getElementById('base-template').innerHTML;
            var html = _lodash2.default.template(baseTemplate)();
        ...
        value: function GenerateItemMarkup(toDoList) {
            ...
            var self = this;
            var ulEl = self.GenerateElement('ul');

            toDoList.forEach(function (toDo) {
                var liEl = self.GenerateElement('li');
                ...
                _events.events.on(todoCheckboxEl, 'click', function (event) {
                    event.preventDefault();
                    toDo._done = !toDo._done;
                    editHandler.DoCheck(toDo);
                    _events.events.send('get-todos-list');
                });
                ...
                var toDoTextEl = self.GenerateElement('span', toDoTextAttr, toDo._text);
                ...
                var toDoEditBtnEl = self.GenerateElement('div', toDoEditBtnAttr, '<span class="glyphicon glyphicon-pencil"></span>');
                toDoBtnContainerEl.appendChild(toDoEditBtnEl);
                var editFunc = function editFunc(event) {
                    event.preventDefault();
                    editHandler.EditToDoItem(toDo, toDoContainerEl);
                };
                _events.events.on(toDoEditBtnEl, 'click', editFunc);
                //Delete Btn
                ...
                _events.events.on(toDoDeleteBtnEl, 'click', function (event) {
                    event.preventDefault();
        ...
        value: function GenerateAddForm() {
            ...
            _events.events.on(formAdd, 'submit', function (event) {
                event.preventDefault();
...
exports.DeleteHandler = undefined;
...
var DeleteHandler = exports.DeleteHandler = function () {
    function DeleteHandler() {
        _classCallCheck(this, DeleteHandler);
    }

    _createClass(DeleteHandler, [{
        key: 'DeleteToDoItem',
        value: function DeleteToDoItem(id) {
            _todoItemManager.toDoItemManager.Delete(id);
        }
    }]);
...
var EditHandler = exports.EditHandler = function () {
    function EditHandler() {
        _classCallCheck(this, EditHandler);
    }

    _createClass(EditHandler, [{
        key: 'EditToDoItem',
        value: function EditToDoItem(toDo, toDoContainer) {
            var textEl = toDoContainer.getElementsByClassName('todo-text')[0];
            textEl.style.display = 'none';

            var textContainer = toDoContainer.getElementsByClassName('toDo-text-container')[0];
            ...
            var btnContainer = toDoContainer.getElementsByClassName(' toDo-btn-container')[0];

            btnContainer.insertBefore(okBtn, btnContainer.firstChild);
            _events.events.on(okBtn, 'click', function (event) {
                event.preventDefault();
                toDo._text = input.value;
                _todoItemManager.toDoItemManager.Edit(toDo);
                _events.events.send('get-todos-list');
            });
        }
    }, {
        key: 'DoCheck',
        value: function DoCheck(toDo) {
            _todoItemManager.toDoItemManager.Edit(toDo);
        }
    }]);
